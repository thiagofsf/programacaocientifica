...
class MyCanvas(QtOpenGL.QGLWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("MyLDrawer")
        self.m_w = 0 #width: L canvas horizontal size
    ...
    def paintGL(self):
        ...
        glClear(GL_COLOR_BUFFER_BIT)
        #draw a triangle with RGB color at the 3 vertices, interpolating smoothly the color in the interior
        xA = self.m_w / 3.0
        yA = self.m_h / 3.0
        xB = self.m_w * ( 2.0/3.0 )
        yB = self.m_h / 3.0
